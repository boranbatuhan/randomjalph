<template>
    <div class="w-64 h-80  border bg-[#390097] border-[#00F171] flex items-center flex-col pb-8 gap-2">
      <div class=" text-white hover:text-[#00F171] cursor-pointer ml-auto m-2 relative group">
        ...
        <div class="w-48 h-44 bg-white/90 absolute top-11 right-5 invisible group-hover:visible transition-all !text-black text-9xl flex items-center justify-center pointer-events-none"> {{ props.resultHiragana }}</div>
      </div>
